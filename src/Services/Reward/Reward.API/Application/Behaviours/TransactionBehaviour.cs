...
namespace Reward.API.Application.Behaviours
{
    public class TransactionBehaviour<TRequest, TResponse> : IPipelineBehavior<TRequest, TResponse>
    {
        private readonly ILogger<TransactionBehaviour<TRequest, TResponse>> _logger;
        private readonly RewardContext _dbContext;
        private readonly IRewardIntegrationDataService _transactionIntegrationDataService;

        public TransactionBehaviour(RewardContext dbContext,
            IRewardIntegrationDataService transactionIntegrationDataService,
            ILogger<TransactionBehaviour<TRequest, TResponse>> logger)
        {
            _dbContext = dbContext ?? throw new ArgumentException(nameof(RewardContext));
